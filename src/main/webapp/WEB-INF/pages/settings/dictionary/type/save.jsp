...
<body>
	...
	<form action="/type/add" class="form-horizontal" role="form" method="post">
					
		<div class="form-group">
			<label for="create-code" class="col-sm-2 control-label">编码<span style="font-size: 15px; color: red;">*</span></label>
			<div class="col-sm-10" style="width: 300px;">
				<input name="code" type="text" class="form-control" id="code" style="width: 200%;">
			</div>
		</div>
		...
		<input type="submit" class="btn btn-primary">保存</input>
	</form>
